    ...
    <body>
        ...
        <div id="content" class="clearfix">
            <section id="left">
                ...
                <div class="pic">
                    <a href="#"><img src="img/friend_avatar_default.jpg" width="150" height="150" /></a>
                </div>
                    <div class="data">
                    <h1><?php
                        if($_GET["fid"] == ""){
            ...
            <section id="right" style="margin-left: -600px; width: 500px">
                <div class="gcontent" style="margin-top: 200px; width: 500px">
                    <div style="margin-left: 50px"><h1>Friends List - 
                    <?php 
                        if($_GET["fid"] == ""){
                            $id = $_GET["id"];
                        }else{
                        ...
                        echo "(".$row[0].")";
                    ?></h1></div>
                    <div class="boxy" style="margin-left: 50px">
                <?php
                    if($_GET["fid"] == ""){
                        $id = $_GET["id"];
                    }else{
                    ...
                    while($row = pg_fetch_row($ret)){
                        ...
                        echo "<div class='clearfix' style='display: inline'>
                    <div class='friend'>
                        <a href='#'><img src='imgs/friend_avatar_default.jpg' width='40' height='40'/></a><span class='friendly'><a href='$temp'>$row[0] $row[1]</a></span>
                    </div>
                    <button type='button' class='btn btn-default dropdown-toggle' data-toggle='dropdown' style='display: inline; background-color: #31b0d5; font-size: 20px; font-weight: 5px'>Following</button>
                    </div>";
                    }
                ?>
        </div>
